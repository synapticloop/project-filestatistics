...
public class NumberTextReporterTest {
	NumberTextReporter numberTextReporter;
	StatisticsBean statisticsBean;

	@Before
	public void setup() {
		numberTextReporter = new NumberTextReporter();
		statisticsBean = mock(StatisticsBean.class);
	}

	@Test
	public void testPrintToConsole() {
		numberTextReporter.print("/tmp/", statisticsBean);
	}
}
