 ...
 * this case, the conversion character % is replaced by the sequence 
 ...
 * on the left; t will be padded on the right, if the left-adjustment 
 * flag (-), described below, is given to the field width.  The field width 
 * takes the form of a decimal integer.  If the conversion character is s, the 
 * field width is the the minimum number of characters to be printed.</p>
 *<p>
 ...
 * inter-operate correctly with the rest of the Java
