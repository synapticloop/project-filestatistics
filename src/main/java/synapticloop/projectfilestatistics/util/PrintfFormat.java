 ...
 * <p>
 * this code was taken from the following location: <a href=
 * "http://java.sun.com/developer/technicalArticles/Programming/sprintf/PrintfFormat.java"
 * target=
 * "_blank">http://java.sun.com/developer/technicalArticles/Programming/sprintf/PrintfFormat.java</a>
 * </p>
 * <p>
 * for more information see: <a href=
 * "http://java.sun.com/developer/technicalArticles/Programming/sprintf/" target
 * =
 * "_blank">http://java.sun.com/developer/technicalArticles/Programming/sprintf/</a>
 * </p>
 * </div> PrintfFormat allows the formatting of an array of objects embedded
 * within a string. Primitive types must be passed using wrapper types. The
 ...
 * the conversion character % is replaced by the sequence %<code>n</code>$,
 ...
 * digit string. In this case, an integer argument supplied the field width
 ...
 * character set and allows the utility to inter-operate correctly with the rest
...
public class PrintfFormat {
	 ...
	 * 	length, or otherwise mal-formed.
	 */
